...
if (-not (Get-Variable -Name 'PDragonCopilotConnectorLoaded' -Scope Global -ErrorAction SilentlyContinue)) {
    ...
    Write-Host "  2. Run Register-CCApp to create the Entra app and get TenantId/AppId." -ForegroundColor White
    Write-Host "  3. Pass TenantId/AppId to New-CCConnection to create the external connection and schema." -ForegroundColor White
    Write-Host ""
}
