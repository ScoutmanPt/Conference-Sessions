...
Describe 'Register-CCApp' {
    ...
    Context 'happy path — no existing app' {
        ...
        It 'does not require config.ini output' {
            $r = Register-CCApp -ConnectorDisplayName 'Test Connector'
            $r.TenantId | Should -Be 'tenant-id-1'
        ...
        It 'returns an object with TenantId, AppId, ObjectId, DisplayName, SecretName, ConfigPath' {
