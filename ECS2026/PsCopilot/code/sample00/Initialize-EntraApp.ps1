<#
Connect-MgGraph -Scopes AppRoleAssignment.ReadWrite.All,Application.ReadWrite.All -NoWelcome -UseDeviceCode
...
$app = New-MgApplication -DisplayName "ROD connector (PowerShell)" -RequiredResourceAccess $requiredResourceAccess
