...
function Read-Content {
    $files = Get-ChildItem -Path (Join-Path $PSScriptRoot "content") -Recurse -File -Filter "*.markdown"
    ...
    $Content | ForEach-Object {
        ...
        $item = @{
            ...
            properties = @{
              ...
              iconUrl = "https://searchuxcdn.blob.core.windows.net/designerapp/images/DefaultMRTIcon.png"
              url = [System.Uri]::new([System.Uri]$baseUrl, $_.Meta.slug).ToString()
              date = $docDate
              lastModifiedBy = "Scoutman"
