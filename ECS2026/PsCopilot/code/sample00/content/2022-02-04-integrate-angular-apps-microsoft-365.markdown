...
Recently, I've been working on integrating a fictitious line of business app built using Angular with Microsoft 365. As usual, the [first step is integrating with Azure AD](https://www.scoutman.pt/bring-app-microsoft-365-3-steps/) to allow users to sign in with their work account. I must admit, it was cool to see how quickly you can integrate the Microsoft identity platform in an Angular app using MSAL Angular. [I got stuck](https://www.scoutman.pt/redirect-custom-login-page-securing-angular-app-msal/) trying to integrate the custom login page in the auth flow but with some help found a solution.
