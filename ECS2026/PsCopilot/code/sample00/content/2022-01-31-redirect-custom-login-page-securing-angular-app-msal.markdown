...
_Big thanks to my colleague [Wassim Chegham](https://github.com/manekinekko) for helping me figure it out. The code in this article is from a [sample app](https://github.com/scoutman/Angular-JumpStart/tree/identity) built by my other colleague [Dan Wahlin](https://github.com/DanWahlin)._
