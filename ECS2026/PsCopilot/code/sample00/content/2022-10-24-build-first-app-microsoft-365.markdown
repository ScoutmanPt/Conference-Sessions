...
See how I built the [upcoming meetings apps using the Microsoft Graph Toolkit](https://github.com/scoutman/graph-mgt-upcomingmeetings).
...
Check it out here: [Find meeting times and schedule a meeting using Microsoft Graph Toolkit](https://github.com/scoutman/mgt-spa-findmeetingtimes).
