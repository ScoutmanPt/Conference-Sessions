...
begin{
    ...
    $entraIdDisplayName = "Rodrigo Pinto (Ignite 2024) - connector (PowerShell)"
    $secretName = "scoutignite2024powershell"
}
process {
    ...
    $externalConnection = @{
        ...
        connection = @{
            id               = "scoutignite2024sessions"
            name             = "SCOUT Ignite 2024 Sessions"
